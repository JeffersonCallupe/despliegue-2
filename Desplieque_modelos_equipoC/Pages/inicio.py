...
from Pages.ensamblado import mostrar_pagina_ensamblado
from Pages.lstm import mostrar_pagina_lstm
from Pages.svm import mostrar_pagina_svm
from Pages.svc import mostrar_pagina_svc
from Pages.rfr_de_regresion import mostrar_pagina_rfr
...
def mostrar_pagina_inicio():
    ...
    if page == "PRESENTACIÓN":
        ...
        from Pages.rbf import mostrar_pagina_rbf  # Importa la función de la página RBF
        mostrar_pagina_rbf()
